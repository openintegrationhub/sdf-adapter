...
async function processAction(msg, cfg) {
 ...
 //const domainId = msg.body.meta.domain;
  ...
  const domainId = '5d9b2511d48c29001a202169';
  const schemaUri = 'person';
  const recordUid = '123';
  const applicationUid = '1';

  const messageWithMetaTemp = {
    meta: {
      domainId: '5d9b2511d48c29001a202169',
      schemaUri: 'person',
      recordUid: '123',
      applicationUid: '1',
      iamToken: process.env.ELASTICIO_IAM_TOKEN,
      flowId,
    },
    data: {
      firstName: 'Foo',
  ...
  const ilsPayload = messageWithMetaTemp.data;
  ...
  console.log(`Message Temp with Data: ${JSON.stringify(messageWithMetaTemp)}`);
