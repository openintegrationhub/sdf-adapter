...
async function processAction(msg, cfg) {
  ...
  // Check if domaindId and schema are given (only required if validation is activated)
  // if (!domainId) {
  ...
  let eventName = 'validation.success';
